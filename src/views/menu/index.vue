	...
	<el-container class="h100 bg-c pad16 menu-jc">
		...
		<el-container class="">
			<el-aside class="mar0 pad0">
				<el-tree ref="tree" class="permission-tree h100" show-checkbox draggable @node-click="nodeClick" :render-content="renderContent" :check-strictly="checkStrictly" :data="routesData" :props="defaultProps" node-key="path" @node-drop="handleDrop" />
			</el-aside>
			<el-main class="bg-w marl16">
				<el-form v-if="Object.keys(form).length" ref="form" :model="form" label-width="102px">
					...
					<el-form-item label="菜单图标">
						<el-input  @focus="setIcon" v-model="form.meta.icon"></el-input>
						
<el-dialog class="dialog-jc"
  title="选择图标"
  :visible.sync="dialogVisible"
  width="80%" 
  :before-close="handleClose">
  	<icons @iconClick="iconClick" :iconsOpt='iconsOpt'></icons>
</el-dialog>
					</el-form-item>
				</el-form>
			</el-main>
